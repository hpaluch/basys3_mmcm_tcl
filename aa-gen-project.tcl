#*****************************************************************************************
# clk_wiz_0_ex.tcl: Tcl script for re-creating this project under ../basys3_mmcm_work/
#
...
set _xil_proj_name_ "basys3_mmcm_work"
...
set script_file "clk_wiz_0_ex.tcl"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a35tcpg236-1 -flow "Vivado Synthesis $ver_major" -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs synth_1]
  set_property flow "Vivado Synthesis $ver_major" [get_runs synth_1]
}
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a35tcpg236-1 -flow "Vivado Implementation $ver_major" -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
  set_property strategy "Vivado Implementation Defaults" [get_runs impl_1]
  set_property flow "Vivado Implementation $ver_major" [get_runs impl_1]
}
